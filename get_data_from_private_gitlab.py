...
commits_url = f'https://gitlab.com/api/v4/projects/{owner}%2F{project}/repository/commits'
...
if response.status_code == 200:
    ...
    for commit in commits_data:
        ...
        commit_author = commit['committer_name']
        commit_date = commit['committed_date']

        commits_df = commits_df.append({'commit_sha':commit_id,
...
pulls_url = f'https://gitlab.com/api/v4/projects/{owner}%2F{project}/merge_requests'
...
if response.status_code == 200:
    ...
    for pull in pulls_data:
        pull_id = pull['id']
        pull_type = pull['state']
        pull_actor = pull['merged_by']['name']
        pull_created_at = pull['updated_at']
